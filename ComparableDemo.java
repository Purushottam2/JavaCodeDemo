...
public class ComparableDemo {
	...
	public static void main(String[] args) {
		...
		studs.add(new Stud (24,"Sony",65));
		studs.add(new Stud (25,"Larry",25));
		studs.add(new Stud (26,"Joseph",36));
		
		Collections.sort(studs,(i,j)-> i.marks>j.marks?1:-1); //Dosen't implement comparable interface unless u specify comparable interface
